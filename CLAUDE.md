...
- Ordnerstruktur (umgesetzt):
  ...
  /scripts
    ...
    /enemies     (EnemyDefinition + 5 Gegnertypen, EnemyCatalog – Gegner-Vielfalt der Echtzeit-Arena, kein Godot-Bezug)
...
- `PPRogueLite.Enemies`: `EnemyDefinition` (abstract: Id/DisplayName/Movement/OnHitEffect/Stats/MoveSpeed/EngagementRange/AttackCooldown/Radius/MinStage) + 5 konkrete Gegnertypen, `EnemyCatalog` (`AllTypes`, `AvailableForStage(stage)`) – kein Godot-Bezug, siehe Gegner-Abschnitt unten (Issue #9).
